...
$mks = 'style="color: ' . $txt_color . '; font-size: ' . $txt_size . 'px; font-weight: ' . $txt_f_weight . ';"';
$scdiv = 'style="background-color: ' . $style . '; margin-top: ' . $share_el_margin_top . 'px; margin-bottom: ' . $share_el_margin_bot . 'px; margin-left: ' . $share_el_margin_left . 'px; margin-right: ' . $share_el_margin_right . 'px; box-shadow: 0px 43px 30px -43px ' . $share_el_box_shad . '; padding-top: ' . $share_el_padding_top . 'px; padding-right: ' . $share_el_padding_right . 'px;
padding-bottom: ' . $share_el_padding_bot . 'px; padding-left: ' . $share_el_padding_left . 'px;"';


$output .= '<div class="share-container" ' . $scdiv . '>';




        $output .= '<div class="column share-column" ' . $mks . '><i class="bi bi-share"></i> Share</div>';

        $output .= '<div class="column buttons-column">';
        $output .= '<ul class="share-buttons">';

        if ( isset( $options['include_seobpsbfw_facebook'] ) ) {
            $output .= '<li class="sne"><a href="https://www.facebook.com/sharer/sharer.php?u=' . esc_url( $permalink ) . '" target="_blank" class="facebook-button" title="Share the ' . $post->post_title . ' on Facebook" aria-label="Share the ' . $post->post_title . ' on Facebook"><i class="bi bi-facebook"></i></a></li>';
        }
