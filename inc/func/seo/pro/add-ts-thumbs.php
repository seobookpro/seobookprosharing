...
<div id="dialog-featimg-page-blocks-overlay"></div>
<div id="dialog-featimg-page-blocks-window">
  <button id="close-dialog-featimg-page-blocks"><span class="material-symbols-outlined">close</span></button>
<div id="dialog-scroll-all">

  <h2>What are Featured Images?</h2>
...
<h3 class="seobpsbfw-page-speed"><span class="dashicons dashicons-wordpress"></span>Featured Images</h3>
...
<br />
        <input type="radio" id="radio-twentysix" name="seobpsbfw_add_wp_theme_page_featured_images_support" value="1" <?php checked($enable_wp_page_featured_images, '1'); ?> checked>
        <label for="radio-twentysix">On</label>
        <input type="radio" id="radio-twentyseven" name="seobpsbfw_add_wp_theme_page_featured_images_support" value="0" <?php checked($enable_wp_page_featured_images, '0'); ?>>
        <label for="radio-twentyseven">Off</label>
</div>
<div class="col-sm-2 text-center">
        <span>FAQ's</span>

        <button class="featimg-blocks" id="open-dialog-featimg-page-blocks"><span class="material-symbols-outlined">info</span></button>
...
<div class="col-sm-5 text-end">
 ...
 <span>Posts</span>
<br />
        <input type="radio" id="radio-twentyeight" name="seobpsbfw_add_wp_theme_post_featured_images_support" value="1" <?php checked($enable_wp_post_featured_images, '1'); ?> checked>
        <label for="radio-twentyeight">On</label>
        <input type="radio" id="radio-twentynine" name="seobpsbfw_add_wp_theme_post_featured_images_support" value="0" <?php checked($enable_wp_post_featured_images, '0'); ?>>
        <label for="radio-twentynine">Off</label>
</div>
...
<div class="progress-bar featimg" style="width: 0.5%"></div>
</div>
</div>
</div>
...
#dialog-featimg-page-blocks-overlay {
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
#dialog-featimg-page-blocks-window {
  position: fixed;
  top: 50%;
  left: 50%;
...
#dialog-featimg-page-blocks-window.open {
        opacity: 1;
        visibility: visible;
...
#close-dialog-featimg-page-blocks {
        position: fixed;
        top: 0px;
        right: 0px;
        background: #ffc009;
...
<script>
document.getElementById('open-dialog-featimg-page-blocks').addEventListener('click', function(event) {
  event.preventDefault();
  document.getElementById('dialog-featimg-page-blocks-overlay').style.display = 'block';
  document.getElementById('dialog-featimg-page-blocks-window').classList.add('open');
});

document.getElementById('close-dialog-featimg-page-blocks').addEventListener('click', function(event) {
  event.preventDefault();
  document.getElementById('dialog-featimg-page-blocks-overlay').style.display = 'none';
  document.getElementById('dialog-featimg-page-blocks-window').classList.remove('open');
});
