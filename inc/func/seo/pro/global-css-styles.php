...
<div id="dialog-global-css-page-blocks-overlay"></div>

<div id="dialog-global-css-page-blocks-overlay"></div>
<div id="dialog-global-css-page-blocks-window">
  <button class="global-css-blocks" id="close-dialog-global-css-page-blocks"><span class="material-symbols-outlined">close</span></button>
<div id="dialog-scroll-all">

  <h2>What is Global CSS Styles?</h2>
...
<details>
<summary>FAQs: Why is it important to disable Global CSS Styles from an SEO perspective?</summary>
<ol>
...
<details>
<summary> FAQs: Does disabling Global CSS Styles affect SERP ranks?</summary>
...
<h3 class="seobpsbfw-page-speed"><span class="dashicons dashicons-wordpress"></span>Global CSS Styles</h3>
<div class="switch-field">

<input type="radio" id="radio-five" name="seobpsbfw_disable_global_css_styles" value="1" <?php checked( $disable_global_styles_css, '1' ); ?> checked>
<label for="radio-five">Off</label>
<input type="radio" id="radio-six" name="seobpsbfw_disable_global_css_styles" value="0" <?php checked( $disable_global_styles_css, '0' ); ?>>
<label for="radio-six">On</label>
<button class="global-css-blocks" id="open-dialog-global-css-page-blocks"><span class="material-symbols-outlined">info</span></button>
...
<div class="progress" role="progressbar" aria-label="Basic example" aria-valuenow="0.5" aria-valuemin="0.5" aria-valuemax="100">
  <div class="progress-bar global-css" style="width: 0.5%"></div>
</div>
</div>
...
#dialog-global-css-page-blocks-overlay {
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
#dialog-global-css-page-blocks-window {
  position: fixed;
  top: 50%;
  left: 50%;
...
#dialog-global-css-page-blocks-window.open {
        opacity: 1;
        visibility: visible;
...
#close-dialog-global-css-page-blocks {
        position: fixed;
        top: 0px;
        right: 0px;
        background: #ffc009;
...
document.getElementById('open-dialog-global-css-page-blocks').addEventListener('click', function(event) {
  event.preventDefault();
  document.getElementById('dialog-global-css-page-blocks-overlay').style.display = 'block';
  document.getElementById('dialog-global-css-page-blocks-window').classList.add('open');
});

document.getElementById('close-dialog-global-css-page-blocks').addEventListener('click', function(event) {
  event.preventDefault();
  document.getElementById('dialog-global-css-page-blocks-overlay').style.display = 'none';
  document.getElementById('dialog-global-css-page-blocks-window').classList.remove('open');
});
